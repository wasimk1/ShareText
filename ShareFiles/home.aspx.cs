    ...
    public partial class home : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    cmdstr = "insert into SHARE_FILES_TEXT_TAB (TXT_FILE_NAME,DATE_TIME,NUM_USER_UNIQUE_NO)  values ('" + newstr.Trim() + "','" + today.ToString(updatedate) + "'," + DropDownList1.SelectedValue.ToString() + ")";
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmdstr = "select st.ID,st.txt_file_name[TEXT],u.ID[USER ID]   from SHARE_FILES_TEXT_TAB st inner join users u on st.NUM_USER_UNIQUE_NO=u.id  order by st.id desc  ";
                SqlCommand cmd = new SqlCommand(cmdstr, conn);
                SqlDataAdapter sd = new SqlDataAdapter(cmd);
        ...
        protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                cmdstr = "select st.ID,st.txt_file_name[TEXT],u.ID[USER ID]   from SHARE_FILES_TEXT_TAB st inner join users u on st.NUM_USER_UNIQUE_NO=u.id  where u.id='" + DropDownList2.SelectedValue.ToString() + "'  order by st.id desc  ";
                SqlCommand cmd = new SqlCommand(cmdstr, conn);
                SqlDataAdapter sd = new SqlDataAdapter(cmd);
